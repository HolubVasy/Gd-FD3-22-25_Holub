   // src/components/AttendanceTable/AttendanceTable.tsx
   ...
   const AttendanceTable: React.FC = () => {
     ...
     const loadInitialData = () => {
       ...
       return initialAttendance; // Return initial data if loading fails
     };
     ...
     const saveData = () => {
       ...
       try {
         ...
         // Wait 2 seconds before enabling the button again
         setTimeout(() => {
           setIsSaving(false);
         }, 2000);
